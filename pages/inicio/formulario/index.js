    ...
    <>
      ...
      <Layout className="bg-white relative overflow-x-hidden">
        <form
          ...
          className="flex flex-col items-center justify-center space-y-4 bg-white p-6 rounded-lg shadow-md max-w-[1600px] md:max-w-lg mx-auto">
          ...
          <div className='grid grid-cols-3 gap-4 sm:grid-cols-2 lg:grid-cols-3 p-6'>
