...
import { CalendarGroupStudent, CalendarGroupTeacher } from '../../components/Calendar-Group';
// import { CalendarGroupTeacher} from '../../components/Calendar-Group';
...
console.log(session.user.role.includes('admin'))}
  ...
  return (
    ...
    { session && session.user&& ( session.user.role.includes('admin')   ||
        ...
        <CalendarGroupTeacher/> : <CalendarGroupStudent/>}
