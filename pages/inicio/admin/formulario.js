...
import Membresy2 from '../../../components/Formularios/Membresy2';
...
function Formulario() {
    ...
    const [Membresy, setMembresy] = useState(false);
    ...
    return (
      <div>
        ...
        <div className='flex  md:flex-row gap-4 justify-center items-center buttons'>
          ...
          <button className='px-4 py-2 bg-primary text-white rounded-md' onClick={mostrarMembresy}>Membresy 1</button>
        </div>
  <div className='pt-8'>
        {Formulario1 && <Form1 />}
        {Formulario2 && <Form2 />}
