...
export default function ModalPagoZELLE(props) {
  ...
  //  gtag_report_conversion('espanolcone.com')
    ...
    let emailMessage = {
      to: props?.email,
      subject: `${props.labelLanguage == "Es" ?"¡Bienvenido/a! Detalles de tu compra y más" : ""// Asunto en Español
      } 
      ${props.labelLanguage == "En" ?"Welcome! Details of your purchase and more" : "" // Asunto en Ingles
      } 
      ${props.labelLanguage == "Pt" ? "Bem-vindo! Detalhes da sua compra e mais" : "" // Asunto en Portugues
      }`,
      content:`
      ${props?.dates?.descripion == "1claseIndividual 1masterclass 1claseengrupo 3unidadesporNivel" ? 
        ...
        `
          ...
          ${props.labelLanguage == "Pt" ?

            // En Portugues
            `
            <p><b>Olá ${props.nombre}!</b></p>
