...
//         <svg
//           key={i}
//           fill={i <= selectedStars ? 'yellow' : 'none'}  //TODO NO FUNCIONA REVISALO HANS
...
//   return (
//     <>
//       <div className="bg-gray-100 p-8 max-w-xs rounded-lg shadow-md" style={{ zIndex: -2 }}>
...
//         <TeachersCard
//           key={index}
//           name={card.namePerson}  // Cambié namePerson por name para coincidir con el nombre de propiedad en la importación
...
export function TeachersCard({ index, name, content, image }) {
  ...
  return (
    <>
      <div className="bg-gray-100 p-8 max-w-xs rounded-lg shadow-md"
