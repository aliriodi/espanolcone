...
const Menu = (props) => {
  ...
  return (
    <>
      ...
      {!props.onlyMenu ? (
        <div
          className={`w-full absolute px-[60px] py-[20px] z-50
                md:px-[25px]`}>
          <div className="bg-white shadow-[0px_4px_24px_#18292F1A] flex justify-between px-[18px] py-[12px] rounded-[8px] items-center">
            ...
            <div className="flex items-center">
              ...
              <Link href={"/inicio/chat/null"}>
                <FontAwesomeIcon
                  className="mr-[22px] text-[25px] text-violet_dark"
                  icon={faCommentDots}
                />
              </Link>
              ...
              <div className="mr-[14px]">
                {/* Nombre */}
                <p className="text-end text-violet_dark text-[14px]">
                  {session?.user?.first_name}
                </p>

                {/* Rol */}
                <p className="text-end text-[#B9B9C3] text-[12px]">
                  {session?.user?.role[0]}
                </p>
              </div>
      ...
      <div
        ...
        {/* Opciones */}
        <nav
          className="my-8 flex flex-row-reverse  h-full justify-between overflow-auto menu"
              ...
              <ul className="text-title_color">
                ...
                <li>
                  <Link
                    className={`flex items-center justify-start my-[20px] self-center px-[15px] py-[12px] border-[#A4ACB91A] border-solid border-[1px] rounded-[7px] transition-all
                                        ${currentPathName ==
                      "/inicio/schudule-group-class" &&
                      "bg-primary text-white"
                      }
                                    hover:bg-primary hover:text-white`}
                    href="/inicio/schudule-group-class">
                    <FontAwesomeIcon icon={faCalendarDays} className=" mr-[10px]" />
                    <p>Agender clase grupal</p>
                  </Link>
                </li>
