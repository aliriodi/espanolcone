...
export const CalendarGroupStudent = () => {
    ...
    useEffect(() => {
        ...
        // console.log('aca estamos', newcalendar)
        ...
        md:flex-col">
          ...
          md:w-full md:mb-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            <h2 className='md:text-[18px]'>Calendario Grupal Estudiante</h2>
                            <p className='md:text-[18px]'>Seleccione la fecha para ver sus clases</p>
