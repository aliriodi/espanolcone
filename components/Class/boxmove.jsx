...
//     if(cXmax<sol1Rect.left){
      
//       setCXmaxe(sol1Rect.right)
//     }
...
//   return () => {
//     if (sol&&sol1) {
//       sol1.removeEventListener("mouseup", function (event) { 
...
export default function Boxmove(props) {
  ...
  const correctPosition = { x: 0, y: 0 };

  // Función que maneja el evento de mouseup
  function handleMouseUp  (event) {
    ...
    if (sol && sol1) {
      ...
      if (cXmax < sol1Rect.left) {
        setCXmax(sol1Rect.right);
      }

      const correctPosition = {
        x: (0.5 * sol1Rect.left + 0.5 * sol1Rect.right),
        y: (0.5 * sol1Rect.top + 0.5 * sol1Rect.bottom),
      };
