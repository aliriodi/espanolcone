...
const masterclass={
      ...
      pt:'sexta-feira, 10 de março, às 17'
    };
      ...
      `${paypalDates?.descripion == "1claseIndividual 1masterclass 1claseengrupo 3unidadesporNivel" ? 
        ...
        `
          ...
          ${t("labelLanguage") == "Pt" ?
            ...
            <p><b>Aula magistral:</b> Junte-se à nossa aula especial no Zoom na ${masterclass.pt} horas (horário da Argentina). Você mergulhará em tópicos fascinantes para estudantes de espanhol de todos os níveis. Desde os sons do espanhol até dicas de motivação, temos muito para explorar!</p>
